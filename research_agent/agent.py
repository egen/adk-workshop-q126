...
root_agent = Agent(name="Research Agent",model="gemini-2.0-flash",instruction="You are a research assistant. Your task is to gather information on a given topic and summarize it concisely.",description="A simple research agent that gathers and summarizes information on a specified topic."))
