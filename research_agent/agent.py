...
root_agent = Agent(
    name="version01_research_agent",
    model="gemini-2.0-flash",
    instruction="""
    You are a helpful research assistant. Your goal is to help users
    find information and answer questions.
    
    You have access to a fetch_webpage tool, use this to collect more information about the topic before responding to the user.
    """,
    description="version01 research agent",
    tools=[
        fetch_webpage
    ]
)
